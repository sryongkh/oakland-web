...
<main>
    <section data-section="privacy-hero" class="header light">
        <div class="container">
            <div class="contxt">
                <h2 class="fluid-heading-1">Privacy and Cookies Policy</h2>
                <p class="fluid-body">This privacy is designed to inform you about how we collect, use, and<br />protect your personal information when you interact with our website.</p>
            </div>
        </div>
    </section>
    <section data-section="policy-list">
        <div class="list">
            <h2 class="fluid-heading-2">1. Information we collect</h2>
            <p class=s"fluid-body">
        ...
        <div class="list">
            <h2 class="fluid-heading-2">2. How we use your information</h2>
            <p class=s"fluid-body">
        ...
        <div class="list">
            <h2 class="fluid-heading-2">3. Communication</h2>
            <p class=s"fluid-body">
        ...
        <div class="list">
            <h2 class="fluid-heading-2">4. Cookies and Tracking Technologies</h2>
            <p class=s"fluid-body">
        ...
        <div class="list">
            <h2 class="fluid-heading-2">5. Security</h2>
            <p class=s"fluid-body">
