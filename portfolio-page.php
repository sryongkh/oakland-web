...
<main id="portpage" data-barba="container" data-barba-namespace="home">
    <section data-section="portpage-hero" class="header light">
        <div class="container">
            <div class="contxt">
                <p>portfolio</p>
                <h2 class="fluid-heading-1">Delloite Building, London</h2>
            </div>
            <div class="navigation">
                <button class="ic ic-nav-left"></button>
                <button class="ic ic-nav-right"></button>
            </div>
        </div>
    </section>
    <section data-section="portpage-content">
        ...
        <div class="image">
            <figure><img src="<?php $root; ?>assets/media/portfolio-1.png" alt=""></figure>
            <figure><img src="<?php $root; ?>assets/media/portfolio-2.png" alt=""></figure>
        </div>
    </section>
